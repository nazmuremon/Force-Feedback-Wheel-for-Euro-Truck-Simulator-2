...
Primary transport is USB CDC serial. This keeps the project aligned with the safest first implementation path for a DIY wheel: the PC computes effects, and the STM32 acts as a motor-and-sensor controller.
